...
//    override func setUp() {
//        super.setUp()
//        manager = CarPlayManager(navigationViewControllerClass: CarPlayNavigationViewControllerTestable.self)
...
//        let service = MapboxNavigationService(route: initialRoute, routeIndex: 0, routeOptions: routeOptions, directions: directionsClientSpy, locationSource: NavigationLocationManager(), simulating: desiredSimulationMode)
//        return service
//    }
//
